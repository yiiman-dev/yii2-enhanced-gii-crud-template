...
<div class="<?= Inflector::camel2id( StringHelper::basename( $generator->modelClass ) ) ?>-view">
    <div class="col-md-12">
        <div class="card card-nav-tabs">
            <h4 class="card-header card-header-info"><?= "<?= " ?><?= $generator->generateString( Inflector::camel2words( StringHelper::basename( $generator->modelClass ) ) ) ?>
                .' '. Html::encode($this->title) ?></h4>
            <div class="card-body">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="<?= ( $generator->saveAsNew ) ? "col-sm-8" : "col-sm-9"; ?>"></div>
						...
						<?php if ( $rel[2] && isset( $rel[3] ) && ! in_array( $name, $generator->skippedRelations ) ): ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    'kv-pjax-container-<?= Inflector::camel2id( $rel[3] ) ?>']],
                                    'panel' => [
                                    'type' => null,
                                    'heading' => false,
                                    'footer'=> false
