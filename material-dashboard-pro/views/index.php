            ...
            <div class="card">
                <div class="card-header card-header-rose">
                    <ul class="nav nav-tabs">
                        <div class="navbar-brand color-white" href="#"><?= "<?= " ?>Html::encode($this->title) ?></div>
                        <li class="nav-item">
                            <a class="nav-link" href="#" data-toggle="modal" data-target="#help"><i class="material-icons">help</i> راهنما </a>
                        </li>
                    </ul>
                </div>
                <div class="card-body" style="margin-top: 20px">
                    <div class="col-md-12">
                            ...
                            <p>
		                        ...
		                        <?php if (!empty($generator->searchModelClass)): ?>
			                        <?= "<?= " ?>Html::a(<?= $generator->generateString('Advance Search')?>, '#', ['class' => 'btn btn-info ','data-toggle'=>'modal','data-target'=>'#search']) ?>
		                        <?php endif; ?>
                            </p>
	                        <?php if (!empty($generator->searchModelClass)): ?>
		                        <?= "<?= " ?> $this->render('_searchModal', ['model' => $searchModel]); ?>
	                        <?php endif; ?>
	                        <?php
